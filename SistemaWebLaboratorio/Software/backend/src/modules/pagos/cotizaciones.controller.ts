...
export class CotizacionesController {
  ...
  @ApiOperation({
    ...
    description: 'Confirma que el paciente pago en el laboratorio y actualiza estado a PAGADA',
  })
  @ApiResponse({ status: 200, description: 'Pago confirmado, cotizacion actualizada' })
  @ApiResponse({ status: 400, description: 'Estado de cotizacion no valido' })
